...
#define BOARD_INITPINS_CSI_D6_PERIPHERAL                                    ADC1   /*!< Device name: ADC1 */
#define BOARD_INITPINS_CSI_D6_SIGNAL                                          IN   /*!< ADC1 signal: IN */
#define BOARD_INITPINS_CSI_D6_CHANNEL                                         0U   /*!< ADC1 IN channel: 0 */
