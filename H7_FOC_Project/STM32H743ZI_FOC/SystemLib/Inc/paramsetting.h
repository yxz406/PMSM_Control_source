...
//高周波重畳の推定制御器のパラメータ
#define OBSERVER_HFKi 1
#define OBSERVER_HFKp 1
#define OBSERVER_HF_BPF_B0 1
#define OBSERVER_HF_BPF_B2 1
#define OBSERVER_HF_BPF_A1 1
#define OBSERVER_HF_BPF_A2 1

#define OBSERVER_HF_LPF_B0 1
#define OBSERVER_HF_LPF_B1 1
#define OBSERVER_HF_LPF_A1 1
