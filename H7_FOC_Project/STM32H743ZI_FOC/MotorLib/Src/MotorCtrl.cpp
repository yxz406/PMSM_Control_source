...
void MotorCtrl::InitObserver(void) {
	...
	mHFConvolution.Init(OBSERVER_CYCLE_TIME, OBSERVER_HFKi, OBSERVER_HFKp);
	mHFConvolution.BPFInit(OBSERVER_HF_BPF_B0, OBSERVER_HF_BPF_B2, OBSERVER_HF_BPF_A1, OBSERVER_HF_BPF_A2);
	mHFConvolution.LPFInit(OBSERVER_HF_LPF_B0, OBSERVER_HF_LPF_B1, OBSERVER_HF_LPF_A1);
}
