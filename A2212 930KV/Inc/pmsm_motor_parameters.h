...
#define NOMINAL_CURRENT         8221
#define MOTOR_MAX_SPEED_RPM     9054 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  1.3 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -8221 /*!< Demagnetization current */
